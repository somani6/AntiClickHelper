...
The addon hooks into your action buttons. When you click a button, it triggers the warning. It also monitors spell casts and compares the timing with your last mouse click to determine if a spell was cast via a keybind.
...
3.  (Optional) Install **SharedMedia** for more sound options.